...
class ConcurrentBitset(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ConcurrentBitset, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ConcurrentBitset, name)
    __repr__ = _swig_repr

    def __init__(self, count, init_value=0):
        this = _swigfaiss.new_ConcurrentBitset(count, init_value)
        try:
    ...
    def __iand__(self, bitset):
        return _swigfaiss.ConcurrentBitset___iand__(self, bitset)

    def __and__(self, bitset):
        return _swigfaiss.ConcurrentBitset___and__(self, bitset)

    def __ior__(self, bitset):
        return _swigfaiss.ConcurrentBitset___ior__(self, bitset)

    def __or__(self, bitset):
        return _swigfaiss.ConcurrentBitset___or__(self, bitset)

    def negate(self):
        return _swigfaiss.ConcurrentBitset_negate(self)

    def test(self, id):
        return _swigfaiss.ConcurrentBitset_test(self, id)

    def set(self, id):
        return _swigfaiss.ConcurrentBitset_set(self, id)

    def clear(self, id):
        return _swigfaiss.ConcurrentBitset_clear(self, id)

    def count(self):
        return _swigfaiss.ConcurrentBitset_count(self)

    def size(self):
        return _swigfaiss.ConcurrentBitset_size(self)

    def data(self):
        return _swigfaiss.ConcurrentBitset_data(self)

    def mutable_data(self):
        return _swigfaiss.ConcurrentBitset_mutable_data(self)

    def count_1(self):
        return _swigfaiss.ConcurrentBitset_count_1(self)
    __swig_destroy__ = _swigfaiss.delete_ConcurrentBitset
    __del__ = lambda self: None
ConcurrentBitset_swigregister = _swigfaiss.ConcurrentBitset_swigregister
ConcurrentBitset_swigregister(ConcurrentBitset)

class BitsetView(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, BitsetView, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, BitsetView, name)
    __repr__ = _swig_repr

    def __init__(self, *args):
        this = _swigfaiss.new_BitsetView(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def empty(self):
        return _swigfaiss.BitsetView_empty(self)

    def size(self):
        return _swigfaiss.BitsetView_size(self)

    def u8size(self):
        return _swigfaiss.BitsetView_u8size(self)

    def data(self):
        return _swigfaiss.BitsetView_data(self)

    def __nonzero__(self):
        return _swigfaiss.BitsetView___nonzero__(self)
    __bool__ = __nonzero__



    def test(self, index):
        return _swigfaiss.BitsetView_test(self, index)

    def count_1(self):
        return _swigfaiss.BitsetView_count_1(self)
    __swig_destroy__ = _swigfaiss.delete_BitsetView
    __del__ = lambda self: None
BitsetView_swigregister = _swigfaiss.BitsetView_swigregister
BitsetView_swigregister(BitsetView)
...
def hamming_range_search(a, b, na, nb, radius, ncodes, result, buffer_size, bitset):
    return _swigfaiss.hamming_range_search(a, b, na, nb, radius, ncodes, result, buffer_size, bitset)
...
def get_L3_Size():
    return _swigfaiss.get_L3_Size()
get_L3_Size = _swigfaiss.get_L3_Size
...
def knn_inner_product(x, y, d, nx, ny, res, bitset=0):
    return _swigfaiss.knn_inner_product(x, y, d, nx, ny, res, bitset)
knn_inner_product = _swigfaiss.knn_inner_product

def knn_L2sqr(x, y, d, nx, ny, res, bitset=0):
    return _swigfaiss.knn_L2sqr(x, y, d, nx, ny, res, bitset)
knn_L2sqr = _swigfaiss.knn_L2sqr

def knn_jaccard(x, y, d, nx, ny, res, bitset=0):
    return _swigfaiss.knn_jaccard(x, y, d, nx, ny, res, bitset)
knn_jaccard = _swigfaiss.knn_jaccard
...
def range_search_L2sqr(x, y, d, nx, ny, radius, result, buffer_size, bitset=0):
    return _swigfaiss.range_search_L2sqr(x, y, d, nx, ny, radius, result, buffer_size, bitset)
range_search_L2sqr = _swigfaiss.range_search_L2sqr

def range_search_inner_product(x, y, d, nx, ny, radius, result, buffer_size, bitset=0):
    return _swigfaiss.range_search_inner_product(x, y, d, nx, ny, radius, result, buffer_size, bitset)
range_search_inner_product = _swigfaiss.range_search_inner_product

def elkan_L2_sse(x, y, d, nx, ny, ids, val):
    return _swigfaiss.elkan_L2_sse(x, y, d, nx, ny, ids, val)
elkan_L2_sse = _swigfaiss.elkan_L2_sse
...
METRIC_Tanimoto = _swigfaiss.METRIC_Tanimoto
METRIC_Hamming = _swigfaiss.METRIC_Hamming
METRIC_Substructure = _swigfaiss.METRIC_Substructure
METRIC_Superstructure = _swigfaiss.METRIC_Superstructure
...
class Index(_object):
    ...
    def add_without_codes(self, n, x):
        return _swigfaiss.Index_add_without_codes(self, n, x)

    def add_with_ids(self, n, x, xids):
        return _swigfaiss.Index_add_with_ids(self, n, x, xids)

    def add_with_ids_without_codes(self, n, x, xids):
        return _swigfaiss.Index_add_with_ids_without_codes(self, n, x, xids)

    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.Index_search(self, n, x, k, distances, labels, bitset)

    def range_search(self, n, x, radius, result, bitset=0):
        return _swigfaiss.Index_range_search(self, n, x, radius, result, bitset)

    def assign(self, n, x, labels, distance=None):
        return _swigfaiss.Index_assign(self, n, x, labels, distance)
...
K_MEANS = _swigfaiss.K_MEANS
K_MEANS_PLUS_PLUS = _swigfaiss.K_MEANS_PLUS_PLUS
K_MEANS_TWO = _swigfaiss.K_MEANS_TWO
...
class Clustering(ClusteringParameters):
    ...
    def kmeans_algorithm(self, centroids_index, random_seed, n_input_centroids, d, k, nx, x_in):
        return _swigfaiss.Clustering_kmeans_algorithm(self, centroids_index, random_seed, n_input_centroids, d, k, nx, x_in)

    def kmeans_plus_plus_algorithm(self, centroids_index, random_seed, n_input_centroids, d, k, nx, x_in):
        return _swigfaiss.Clustering_kmeans_plus_plus_algorithm(self, centroids_index, random_seed, n_input_centroids, d, k, nx, x_in)
...
def knn_extra_metrics(x, y, d, nx, ny, mt, metric_arg, res, bitset=0):
    return _swigfaiss.knn_extra_metrics(x, y, d, nx, ny, mt, metric_arg, res, bitset)
...
class ProductQuantizer(_object):
    ...
    def cal_size(self):
        return _swigfaiss.ProductQuantizer_cal_size(self)
...
class IndexPreTransform(Index):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexPreTransform_search(self, n, x, k, distances, labels, bitset)

    def range_search(self, n, x, radius, result, bitset=0):
        return _swigfaiss.IndexPreTransform_range_search(self, n, x, radius, result, bitset)
...
class IndexFlat(Index):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexFlat_search(self, n, x, k, distances, labels, bitset)

    def assign(self, n, x, labels, distances=None):
        return _swigfaiss.IndexFlat_assign(self, n, x, labels, distances)

    def range_search(self, *args):
        return _swigfaiss.IndexFlat_range_search(self, *args)
    ...
    def cal_size(self):
        return _swigfaiss.IndexFlat_cal_size(self)
...
class IndexFlatL2BaseShift(IndexFlatL2):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexFlatL2BaseShift_search(self, n, x, k, distances, labels, bitset)
...
class IndexRefineFlat(Index):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexRefineFlat_search(self, n, x, k, distances, labels, bitset)
...
class IndexFlat1D(IndexFlatL2):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexFlat1D_search(self, n, x, k, distances, labels, bitset)
...
class IndexLSH(Index):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexLSH_search(self, n, x, k, distances, labels, bitset)
...
class IndexPQ(Index):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexPQ_search(self, n, x, k, distances, labels, bitset)
    ...
    def cal_size(self):
        return _swigfaiss.IndexPQ_cal_size(self)
...
class MultiIndexQuantizer(Index):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.MultiIndexQuantizer_search(self, n, x, k, distances, labels, bitset)
...
class MultiIndexQuantizer2(MultiIndexQuantizer):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.MultiIndexQuantizer2_search(self, n, x, k, distances, labels, bitset)
...
class InvertedLists(_object):
    ...
    def add_entry_without_codes(self, list_no, theid):
        return _swigfaiss.InvertedLists_add_entry_without_codes(self, list_no, theid)

    def add_entries_without_codes(self, list_no, n_entry, ids):
        return _swigfaiss.InvertedLists_add_entries_without_codes(self, list_no, n_entry, ids)
    ...
    def to_readonly(self):
        return _swigfaiss.InvertedLists_to_readonly(self)

    def to_readonly_without_codes(self):
        return _swigfaiss.InvertedLists_to_readonly_without_codes(self)

    def is_readonly(self):
        return _swigfaiss.InvertedLists_is_readonly(self)
...
class ArrayInvertedLists(InvertedLists):
    ...
    def add_entries_without_codes(self, list_no, n_entry, ids):
        return _swigfaiss.ArrayInvertedLists_add_entries_without_codes(self, list_no, n_entry, ids)
    ...
    def to_readonly(self):
        return _swigfaiss.ArrayInvertedLists_to_readonly(self)

    def to_readonly_without_codes(self):
        return _swigfaiss.ArrayInvertedLists_to_readonly_without_codes(self)
...
class ReadOnlyArrayInvertedLists(InvertedLists):
    __swig_setmethods__ = {}
    for _s in [InvertedLists]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ReadOnlyArrayInvertedLists, name, value)
    __swig_getmethods__ = {}
    for _s in [InvertedLists]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, ReadOnlyArrayInvertedLists, name)
    __repr__ = _swig_repr
    __swig_setmethods__["readonly_codes"] = _swigfaiss.ReadOnlyArrayInvertedLists_readonly_codes_set
    __swig_getmethods__["readonly_codes"] = _swigfaiss.ReadOnlyArrayInvertedLists_readonly_codes_get
    if _newclass:
        readonly_codes = _swig_property(_swigfaiss.ReadOnlyArrayInvertedLists_readonly_codes_get, _swigfaiss.ReadOnlyArrayInvertedLists_readonly_codes_set)
    __swig_setmethods__["readonly_ids"] = _swigfaiss.ReadOnlyArrayInvertedLists_readonly_ids_set
    __swig_getmethods__["readonly_ids"] = _swigfaiss.ReadOnlyArrayInvertedLists_readonly_ids_get
    if _newclass:
        readonly_ids = _swig_property(_swigfaiss.ReadOnlyArrayInvertedLists_readonly_ids_get, _swigfaiss.ReadOnlyArrayInvertedLists_readonly_ids_set)
    __swig_setmethods__["readonly_length"] = _swigfaiss.ReadOnlyArrayInvertedLists_readonly_length_set
    __swig_getmethods__["readonly_length"] = _swigfaiss.ReadOnlyArrayInvertedLists_readonly_length_get
    if _newclass:
        readonly_length = _swig_property(_swigfaiss.ReadOnlyArrayInvertedLists_readonly_length_get, _swigfaiss.ReadOnlyArrayInvertedLists_readonly_length_set)
    __swig_setmethods__["readonly_offset"] = _swigfaiss.ReadOnlyArrayInvertedLists_readonly_offset_set
    __swig_getmethods__["readonly_offset"] = _swigfaiss.ReadOnlyArrayInvertedLists_readonly_offset_get
    if _newclass:
        readonly_offset = _swig_property(_swigfaiss.ReadOnlyArrayInvertedLists_readonly_offset_get, _swigfaiss.ReadOnlyArrayInvertedLists_readonly_offset_set)
    __swig_setmethods__["valid"] = _swigfaiss.ReadOnlyArrayInvertedLists_valid_set
    __swig_getmethods__["valid"] = _swigfaiss.ReadOnlyArrayInvertedLists_valid_get
    if _newclass:
        valid = _swig_property(_swigfaiss.ReadOnlyArrayInvertedLists_valid_get, _swigfaiss.ReadOnlyArrayInvertedLists_valid_set)

    def __init__(self, *args):
        this = _swigfaiss.new_ReadOnlyArrayInvertedLists(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _swigfaiss.delete_ReadOnlyArrayInvertedLists
    __del__ = lambda self: None

    def list_size(self, list_no):
        return _swigfaiss.ReadOnlyArrayInvertedLists_list_size(self, list_no)

    def get_codes(self, list_no):
        return _swigfaiss.ReadOnlyArrayInvertedLists_get_codes(self, list_no)

    def get_ids(self, list_no):
        return _swigfaiss.ReadOnlyArrayInvertedLists_get_ids(self, list_no)

    def get_all_codes(self):
        return _swigfaiss.ReadOnlyArrayInvertedLists_get_all_codes(self)

    def get_all_ids(self):
        return _swigfaiss.ReadOnlyArrayInvertedLists_get_all_ids(self)

    def get_list_length(self):
        return _swigfaiss.ReadOnlyArrayInvertedLists_get_list_length(self)

    def add_entries(self, list_no, n_entry, ids, code):
        return _swigfaiss.ReadOnlyArrayInvertedLists_add_entries(self, list_no, n_entry, ids, code)

    def add_entries_without_codes(self, list_no, n_entry, ids):
        return _swigfaiss.ReadOnlyArrayInvertedLists_add_entries_without_codes(self, list_no, n_entry, ids)

    def update_entries(self, list_no, offset, n_entry, ids, code):
        return _swigfaiss.ReadOnlyArrayInvertedLists_update_entries(self, list_no, offset, n_entry, ids, code)

    def resize(self, list_no, new_size):
        return _swigfaiss.ReadOnlyArrayInvertedLists_resize(self, list_no, new_size)

    def is_readonly(self):
        return _swigfaiss.ReadOnlyArrayInvertedLists_is_readonly(self)

    def is_valid(self):
        return _swigfaiss.ReadOnlyArrayInvertedLists_is_valid(self)
ReadOnlyArrayInvertedLists_swigregister = _swigfaiss.ReadOnlyArrayInvertedLists_swigregister
ReadOnlyArrayInvertedLists_swigregister(ReadOnlyArrayInvertedLists)
...
class ReadOnlyInvertedLists(InvertedLists):
    ...
    def add_entries_without_codes(self, list_no, n_entry, ids):
        return _swigfaiss.ReadOnlyInvertedLists_add_entries_without_codes(self, list_no, n_entry, ids)
...
class Level1Quantizer(_object):
    ...
    __swig_setmethods__["quantizer_backup"] = _swigfaiss.Level1Quantizer_quantizer_backup_set
    __swig_getmethods__["quantizer_backup"] = _swigfaiss.Level1Quantizer_quantizer_backup_get
    if _newclass:
        quantizer_backup = _swig_property(_swigfaiss.Level1Quantizer_quantizer_backup_get, _swigfaiss.Level1Quantizer_quantizer_backup_set)
...
class IndexIVF(Index, Level1Quantizer):
    ...
    __swig_setmethods__["nprobe_statistics"] = _swigfaiss.IndexIVF_nprobe_statistics_set
    __swig_getmethods__["nprobe_statistics"] = _swigfaiss.IndexIVF_nprobe_statistics_get
    if _newclass:
        nprobe_statistics = _swig_property(_swigfaiss.IndexIVF_nprobe_statistics_get, _swigfaiss.IndexIVF_nprobe_statistics_set)
    __swig_setmethods__["index_ivf_stats"] = _swigfaiss.IndexIVF_index_ivf_stats_set
    __swig_getmethods__["index_ivf_stats"] = _swigfaiss.IndexIVF_index_ivf_stats_get
    if _newclass:
        index_ivf_stats = _swig_property(_swigfaiss.IndexIVF_index_ivf_stats_get, _swigfaiss.IndexIVF_index_ivf_stats_set)
    ...
    def add_without_codes(self, n, x):
        return _swigfaiss.IndexIVF_add_without_codes(self, n, x)

    def add_with_ids(self, n, x, xids):
        return _swigfaiss.IndexIVF_add_with_ids(self, n, x, xids)

    def add_with_ids_without_codes(self, n, x, xids):
        return _swigfaiss.IndexIVF_add_with_ids_without_codes(self, n, x, xids)
    ...
    def search_preassigned(self, n, x, k, assign, centroid_dis, distances, labels, store_pairs, params=None, bitset=0):
        return _swigfaiss.IndexIVF_search_preassigned(self, n, x, k, assign, centroid_dis, distances, labels, store_pairs, params, bitset)

    def search_preassigned_without_codes(self, n, x, arranged_codes, prefix_sum, is_sq8, k, assign, centroid_dis, distances, labels, store_pairs, params=None, bitset=0):
        return _swigfaiss.IndexIVF_search_preassigned_without_codes(self, n, x, arranged_codes, prefix_sum, is_sq8, k, assign, centroid_dis, distances, labels, store_pairs, params, bitset)

    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexIVF_search(self, n, x, k, distances, labels, bitset)

    def search_without_codes(self, n, x, arranged_codes, prefix_sum, is_sq8, k, distances, labels, bitset=0):
        return _swigfaiss.IndexIVF_search_without_codes(self, n, x, arranged_codes, prefix_sum, is_sq8, k, distances, labels, bitset)

    def range_search(self, n, x, radius, result, bitset=0):
        return _swigfaiss.IndexIVF_range_search(self, n, x, radius, result, bitset)

    def range_search_preassigned(self, nx, x, radius, keys, coarse_dis, result, bitset=0):
        return _swigfaiss.IndexIVF_range_search_preassigned(self, nx, x, radius, keys, coarse_dis, result, bitset)
    ...
    def to_readonly(self):
        return _swigfaiss.IndexIVF_to_readonly(self)

    def to_readonly_without_codes(self):
        return _swigfaiss.IndexIVF_to_readonly_without_codes(self)

    def is_readonly(self):
        return _swigfaiss.IndexIVF_is_readonly(self)

    def backup_quantizer(self):
        return _swigfaiss.IndexIVF_backup_quantizer(self)

    def restore_quantizer(self):
        return _swigfaiss.IndexIVF_restore_quantizer(self)
    ...
    def clear_nprobe_statistics(self):
        return _swigfaiss.IndexIVF_clear_nprobe_statistics(self)
    ...
    def dump(self):
        return _swigfaiss.IndexIVF_dump(self)
...
def search_with_parameters(index, n, x, k, distances, labels, params, nb_dis=None):
    return _swigfaiss.search_with_parameters(index, n, x, k, distances, labels, params, nb_dis)
...
class ScalarQuantizer(_object):
    ...
    def cal_size(self):
        return _swigfaiss.ScalarQuantizer_cal_size(self)
...
class IndexScalarQuantizer(Index):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexScalarQuantizer_search(self, n, x, k, distances, labels, bitset)
    ...
    def cal_size(self):
        return _swigfaiss.IndexScalarQuantizer_cal_size(self)
...
class IndexIVFScalarQuantizer(IndexIVF):
    ...
    def add_with_ids_without_codes(self, n, x, xids):
        return _swigfaiss.IndexIVFScalarQuantizer_add_with_ids_without_codes(self, n, x, xids)
...
class IndexHNSW(Index):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexHNSW_search(self, n, x, k, distances, labels, bitset)
...
class IndexHNSW2Level(IndexHNSW):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexHNSW2Level_search(self, n, x, k, distances, labels, bitset)
...
class IndexIVFFlat(IndexIVF):
    ...
    def add_with_ids_without_codes(self, n, x, xids):
        return _swigfaiss.IndexIVFFlat_add_with_ids_without_codes(self, n, x, xids)
...
class IndexIVFFlatDedup(IndexIVFFlat):
    ...
    def search_preassigned(self, n, x, k, assign, centroid_dis, distances, labels, store_pairs, params=None, bitset=0):
        return _swigfaiss.IndexIVFFlatDedup_search_preassigned(self, n, x, k, assign, centroid_dis, distances, labels, store_pairs, params, bitset)

    def remove_ids(self, sel):
        return _swigfaiss.IndexIVFFlatDedup_remove_ids(self, sel)

    def range_search(self, n, x, radius, result, bitset=0):
        return _swigfaiss.IndexIVFFlatDedup_range_search(self, n, x, radius, result, bitset)
...
class IndexLattice(Index):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexLattice_search(self, n, x, k, distances, labels, bitset)
...
class IndexIVFPQR(IndexIVFPQ):
    ...
    def search_preassigned(self, n, x, k, assign, centroid_dis, distances, labels, store_pairs, params=None, bitset=0):
        return _swigfaiss.IndexIVFPQR_search_preassigned(self, n, x, k, assign, centroid_dis, distances, labels, store_pairs, params, bitset)
...
class Index2Layer(Index):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.Index2Layer_search(self, n, x, k, distances, labels, bitset)
    ...
    def cal_size(self):
        return _swigfaiss.Index2Layer_cal_size(self)
...
class IndexBinary(_object):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexBinary_search(self, n, x, k, distances, labels, bitset)

    def range_search(self, n, x, radius, result, bitset=0):
        return _swigfaiss.IndexBinary_range_search(self, n, x, radius, result, bitset)
...
class IndexBinaryFlat(IndexBinary):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexBinaryFlat_search(self, n, x, k, distances, labels, bitset)

    def range_search(self, *args):
        return _swigfaiss.IndexBinaryFlat_range_search(self, *args)
...
class IndexBinaryIVF(IndexBinary):
    ...
    __swig_setmethods__["nprobe_statistics"] = _swigfaiss.IndexBinaryIVF_nprobe_statistics_set
    __swig_getmethods__["nprobe_statistics"] = _swigfaiss.IndexBinaryIVF_nprobe_statistics_get
    if _newclass:
        nprobe_statistics = _swig_property(_swigfaiss.IndexBinaryIVF_nprobe_statistics_get, _swigfaiss.IndexBinaryIVF_nprobe_statistics_set)
    __swig_setmethods__["index_ivf_stats"] = _swigfaiss.IndexBinaryIVF_index_ivf_stats_set
    __swig_getmethods__["index_ivf_stats"] = _swigfaiss.IndexBinaryIVF_index_ivf_stats_get
    if _newclass:
        index_ivf_stats = _swig_property(_swigfaiss.IndexBinaryIVF_index_ivf_stats_get, _swigfaiss.IndexBinaryIVF_index_ivf_stats_set)
    ...
    def search_preassigned(self, n, x, k, assign, centroid_dis, distances, labels, store_pairs, params=None, bitset=0):
        return _swigfaiss.IndexBinaryIVF_search_preassigned(self, n, x, k, assign, centroid_dis, distances, labels, store_pairs, params, bitset)

    def get_InvertedListScanner(self, store_pairs=False):
        return _swigfaiss.IndexBinaryIVF_get_InvertedListScanner(self, store_pairs)

    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexBinaryIVF_search(self, n, x, k, distances, labels, bitset)

    def range_search(self, n, x, radius, result, bitset=0):
        return _swigfaiss.IndexBinaryIVF_range_search(self, n, x, radius, result, bitset)
    ...
    def clear_nprobe_statistics(self):
        return _swigfaiss.IndexBinaryIVF_clear_nprobe_statistics(self)
...
class IndexBinaryFromFloat(IndexBinary):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexBinaryFromFloat_search(self, n, x, k, distances, labels, bitset)
...
class IndexBinaryHNSW(IndexBinary):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexBinaryHNSW_search(self, n, x, k, distances, labels, bitset)
...
class IndexBinaryHash(IndexBinary):
    ...
    def range_search(self, n, x, radius, result, bitset=0):
        return _swigfaiss.IndexBinaryHash_range_search(self, n, x, radius, result, bitset)

    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexBinaryHash_search(self, n, x, k, distances, labels, bitset)
...
class IndexBinaryMultiHash(IndexBinary):
    ...
    def range_search(self, n, x, radius, result, bitset=0):
        return _swigfaiss.IndexBinaryMultiHash_range_search(self, n, x, radius, result, bitset)

    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexBinaryMultiHash_search(self, n, x, k, distances, labels, bitset)
...
class IndexShards(ThreadedIndexBase):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexShards_search(self, n, x, k, distances, labels, bitset)
...
class IndexBinaryShards(ThreadedIndexBaseBinary):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexBinaryShards_search(self, n, x, k, distances, labels, bitset)
...
class IndexReplicas(ThreadedIndexBase):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexReplicas_search(self, n, x, k, distances, labels, bitset)
...
class IndexBinaryReplicas(ThreadedIndexBaseBinary):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexBinaryReplicas_search(self, n, x, k, distances, labels, bitset)
...
class IndexSplitVectors(Index):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexSplitVectors_search(self, n, x, k, distances, labels, bitset)
...
class IndexIDMap(Index):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexIDMap_search(self, n, x, k, distances, labels, bitset)
    ...
    def range_search(self, n, x, radius, result, bitset=0):
        return _swigfaiss.IndexIDMap_range_search(self, n, x, radius, result, bitset)
...
class IndexBinaryIDMap(IndexBinary):
    ...
    def search(self, n, x, k, distances, labels, bitset=0):
        return _swigfaiss.IndexBinaryIDMap_search(self, n, x, k, distances, labels, bitset)
    ...
    def range_search(self, n, x, radius, result, bitset=0):
        return _swigfaiss.IndexBinaryIDMap_range_search(self, n, x, radius, result, bitset)
...
class BufferedIOReader(IOReader):
    ...
    __swig_setmethods__["totsz"] = _swigfaiss.BufferedIOReader_totsz_set
    __swig_getmethods__["totsz"] = _swigfaiss.BufferedIOReader_totsz_get
    if _newclass:
        totsz = _swig_property(_swigfaiss.BufferedIOReader_totsz_get, _swigfaiss.BufferedIOReader_totsz_set)
    ...
    def __init__(self, *args):
        this = _swigfaiss.new_BufferedIOReader(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
def write_index_nm(*args):
    return _swigfaiss.write_index_nm(*args)
write_index_nm = _swigfaiss.write_index_nm
...
def read_index_nm(*args):
    return _swigfaiss.read_index_nm(*args)
read_index_nm = _swigfaiss.read_index_nm
...
def write_InvertedLists_nm(ils, f):
    return _swigfaiss.write_InvertedLists_nm(ils, f)
write_InvertedLists_nm = _swigfaiss.write_InvertedLists_nm

def read_InvertedLists_nm(reader, io_flags=0):
    return _swigfaiss.read_InvertedLists_nm(reader, io_flags)
read_InvertedLists_nm = _swigfaiss.read_InvertedLists_nm

def clone_index(arg1):
    return _swigfaiss.clone_index(arg1)
clone_index = _swigfaiss.clone_index
class IndexComposition(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, IndexComposition, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, IndexComposition, name)
    __repr__ = _swig_repr
    __swig_setmethods__["index"] = _swigfaiss.IndexComposition_index_set
    __swig_getmethods__["index"] = _swigfaiss.IndexComposition_index_get
    if _newclass:
        index = _swig_property(_swigfaiss.IndexComposition_index_get, _swigfaiss.IndexComposition_index_set)
    __swig_setmethods__["quantizer"] = _swigfaiss.IndexComposition_quantizer_set
    __swig_getmethods__["quantizer"] = _swigfaiss.IndexComposition_quantizer_get
    if _newclass:
        quantizer = _swig_property(_swigfaiss.IndexComposition_quantizer_get, _swigfaiss.IndexComposition_quantizer_set)
    __swig_setmethods__["mode"] = _swigfaiss.IndexComposition_mode_set
    __swig_getmethods__["mode"] = _swigfaiss.IndexComposition_mode_get
    if _newclass:
        mode = _swig_property(_swigfaiss.IndexComposition_mode_get, _swigfaiss.IndexComposition_mode_set)

    def __init__(self):
        this = _swigfaiss.new_IndexComposition()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _swigfaiss.delete_IndexComposition
    __del__ = lambda self: None
IndexComposition_swigregister = _swigfaiss.IndexComposition_swigregister
IndexComposition_swigregister(IndexComposition)
...
class Cloner(_object):
    ...
    def clone_Index(self, *args):
        return _swigfaiss.Cloner_clone_Index(self, *args)
...
def index_binary_factory(d, description, metric):
    return _swigfaiss.index_binary_factory(d, description, metric)
